...
function program1(depth0,data) {
  ...
  buffer += "<div>\n    ";
  buffer += "<h3>Usage</h3> \n    ";
  buffer += "<p>In order to use this API you only need to send requests to each URL adding a header called Authorization which should be set with your 'api_key' credential. It should be something like the following:";
  buffer += "<br/><br/>    ";
  buffer += "</p>    ";
  buffer += "<div style=\"padding-bottom:5px; margin-left: 10px; border: 2px solid #999999; border-radius: 10px;\">    ";
  buffer += "<code>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp; ..";
  buffer += "<br/>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp; Request URL: https://edify-cl-qa.herokuapp.com/api/v1/learningObjects?all=false&from=0&size=10";
  buffer += "<br/>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp; Request Method: GET";
  buffer += "<br/>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp; ..";
  buffer += "<br/>    ";
  ...
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ..";
  buffer += "<br/>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Authorization: 05473d65c0e39175cd24838948g56a66e1ec3173790362838c6fd302b0a6a46e";
  buffer += "<br/>    ";
  buffer += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ..</code> \n    ";
  buffer += "</div>\n    ";
  buffer += "<br/>    ";
  buffer += "<p>And that's it, you are ready to add your content and organize it. Here are some <a href=\"./examples.html/\">code examples</a>";
  buffer += "</p>    ";
  buffer += "<br/>    ";
  buffer += "</div>\n    ";
...
function program2(depth0,data) {
  ...
  buffer += "<div class=\"info_tos\"><a href=\""
    ...
    + "\" target='_blank'>Terms of service</a></div>";
  return buffer;
  }
